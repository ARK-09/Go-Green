...
class ViewJob : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewJobBinding = ActivityViewJobBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setFragmentResultListener("viewJob") { _, bundle ->
...
//    C:\Users\Amar\AppData\Local\Android\Sdk\platform-tools
