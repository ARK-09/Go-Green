...
class JobRepository(private val jobDao: JobDao, private val jobService: JobService) {
    ...
    suspend fun getJobsByCurrentUserFromServer(): ApiResponse<JobSearchResponse> {
        return handleApiCall {
         jobService.getJobs()
        }
    }
    ...
    suspend fun getJobWithCategoriesAndSkillsAndAttachmentsFromLocal(jobId: String): JobWithCategoriesAndSkillsAndAttachments {
